...
export function extractDataUrl(config) {
    ...
    if (!dataUrl) {
        throw new FireError(`There was no DATABASE URL provided! This needs to be passed in as part of the configuration or as the FIREBASE_DATABASE_URL environment variable.`);
    }
    return dataUrl;
}
