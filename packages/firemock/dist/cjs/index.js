...
class Reference extends Query {
    ...
    toString() {
        return this.path
            ? slashNotation$1(join('FireMock::Reference@', this.path, this.key))
...
async function importFakerLibrary() {
    if (!faker) {
        faker = await Promise.resolve().then(function () { return require(/* webpackChunkName: "faker-lib" */ './index-0ca82466.js'); }).then(function (n) { return n.index; });
    }
    return faker;
}
/**
