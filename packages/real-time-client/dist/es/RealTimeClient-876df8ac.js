...
class RealTimeDb extends AbstractedDatabase {
    ...
    async getFireMock(config = {}) {
        ...
        /* webpackChunkName: "firemock" */ './index-60e93a0b.js');
...
class RealTimeClient extends RealTimeDb {
    ...
    static async connectedTo() {
        return Array.from(new Set(firebase$1.apps.map((i) => i.name)));
    }
    async connect() {
    ...
    get authProviders() {
        ...
        if (!this._authProviders) {
            ...
            this._authProviders = firebase$1.auth;
        }
    ...
    async _connectRealDb(config) {
        if (!this._isConnected) {
            ...
            this._database = firebase$1.database(this._app);
            if (config.useAuth) {
...
export { MOCK_LOADING_TIMEOUT as M, RealTimeClient as R, SerializedRealTimeQuery as S, RealQueryOrderType as a, createCommonjsModule as b, commonjsGlobal as c, lodash_get as l };
