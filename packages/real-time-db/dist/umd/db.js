(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "common-types", "typed-conversions", "serialized-query", "./util", "./errors/FileDepthExceeded", "./errors/UndefinedAssignment", "./WatcherEventWrapper", "abstracted-database", "./errors", "./errors/AbstractedProxyError", ".", "./errors/AbstractedError"], factory);
    }
