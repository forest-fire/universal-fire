...
class AbstractedProxyError extends Error {
    constructor(e, typeSubtype = null, context) {
        ...
        this.stack = e.stack;
        try {
            this.stackFrames = commonTypes.parseStack(this.stack, {
...
exports.VALID_REAL_TIME_EVENTS = VALID_REAL_TIME_EVENTS;
exports.WatcherEventWrapper = WatcherEventWrapper;
