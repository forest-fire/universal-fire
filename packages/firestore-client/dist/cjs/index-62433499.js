...
Promise.resolve().then(function () { return require('./index.esm-94f92c08.js'); });
class FirestoreClient extends FirestoreDb {
    ...
    async loadAuthApi() {
        await Promise.resolve().then(function () { return require('./auth.esm-b37b68cf.js'); });
    }
    async loadFirestoreApi() {
        await Promise.resolve().then(function () { return require('./index.esm-94f92c08.js'); });
    }
}
...
exports.isUWP = isUWP;
//# sourceMappingURL=index-62433499.js.map
