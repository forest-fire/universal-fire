...
var index_esm = require('./index.esm-e6d606d0.js');
 ...
 * limitations under the License.
 */
/** The semver (www.semver.org) version of the SDK. */ var E$1 = index_esm.firebase$1.SDK_VERSION, b = /** @class */ function() {
    function t(t) {
        this.uid = t;
    }
...
var T$1 = {
    ...
    return index_esm.__extends(n, e), n;
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            if (t.A !== e) throw new I$1(T$1.ABORTED, "getToken aborted due to token change.");
            return n ? (Ve("string" == typeof n.accessToken), new N$1(n.accessToken, t.currentUser)) : null;
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new I$1(T$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new I$1(T$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new I$1(T$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new I$1(T$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
...
}(), R$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return index_esm.__extends(n, e), n.prototype.k = function(t, e, r) {
        return new n(t, e, r);
    ...
    n.K = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
var O$1 = /^[_a-zA-Z][_a-zA-Z0-9]*$/, P$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return index_esm.__extends(n, e), n.prototype.k = function(t, e, r) {
    ...
    n.X = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new I$1(T$1.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new I$1(T$1.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new I$1(T$1.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n;
}(V$1);

/** A dot-separated path for navigating sub-objects within a document. */ P$1.G = new P$1([]);
...
var Q$1 = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);

/** Extracts the backend's type order for the provided value. */ function W$1(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? G$1(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : xe();
}

/** Tests `left` and `right` for equality based on the backend semantics. */ function K$1(t, e) {
    var n = W$1(t);
    if (n !== W$1(e)) return !1;
    switch (n) {
      case 0 /* NullValue */ :
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            return J$1(t.geoPointValue.latitude) === J$1(e.geoPointValue.latitude) && J$1(t.geoPointValue.longitude) === J$1(e.geoPointValue.longitude);
        }(t, e);

      case 2 /* NumberValue */ :
        return function(t, e) {
            if ("integerValue" in t && "integerValue" in e) return J$1(t.integerValue) === J$1(e.integerValue);
            if ("doubleValue" in t && "doubleValue" in e) {
                var n = J$1(t.doubleValue), r = J$1(e.doubleValue);
      ...
      case 9 /* ArrayValue */ :
        return Le(t.arrayValue.values || [], e.arrayValue.values || [], K$1);

      case 10 /* ObjectValue */ :
        return function(t, e) {
            var n = t.mapValue.fields || {}, r = e.mapValue.fields || {};
            if (U$1(n) !== U$1(r)) return !1;
            for (var i in n) if (n.hasOwnProperty(i) && (void 0 === r[i] || !K$1(n[i], r[i]))) return !1;
            return !0;
        }(t, e);
...
function H$1(t, e) {
    ...
    switch (n) {
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            var n = J$1(t.integerValue || t.doubleValue), r = J$1(e.integerValue || e.doubleValue);
      ...
      case 3 /* TimestampValue */ :
        return X$1(t.timestampValue, e.timestampValue);
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = Pe(J$1(t.latitude), J$1(e.latitude));
            return 0 !== n ? n : Pe(J$1(t.longitude), J$1(e.longitude));
...
function X$1(t, e) {
    ...
    var n = Z$1(t), r = Z$1(e), i = Pe(n.seconds, r.seconds);
...
function $(t) {
    return function t(e) {
        ...
        L$1.Z(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
var at = /** @class */ function() {
    ...
    return t.prototype.ot = function(t, e) {
        ...
        return e instanceof t && Le(this.elements, e.elements, K$1);
    }, t;
}(), ht = /** @class */ function() {
    function t(t) {
        this.elements = t;
    ...
    t.prototype.ut = function(t) {
        ...
        return e instanceof t && K$1(this.ct, e.ct);
    }, t.prototype.asNumber = function(t) {
        return J$1(t.integerValue || t.doubleValue);
    }, t;
}();
...
e) {
     ...
     */
    t.wt = function(t) {
        return t instanceof kt ? t.version : x$1.min();
    }, t;
}(), mt = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return index_esm.__extends(n, e), n.prototype.at = function(t, e) {
        this.It(t);
    ...
    return index_esm.__extends(n, e), n.prototype.at = function(t, e) {
        ...
        return this.It(t), this.Rt.Et(t) ? new St(this.key, x$1.min()) : t;
    }, n.prototype.Pt = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
...
var At, _t, Dt = function(t, e) {
    ...
    return index_esm.__extends(n, e), n.prototype.field = function(t) {
    ...
    return index_esm.__extends(n, e), n.prototype.toString = function() {
    ...
    return t.prototype.canonicalId = function() {
        ...
        return L$1.et(this.path) && null === this.collectionGroup && 0 === this.filters.length;
    }, t;
}(), Rt = /** @class */ function() {
    /**
    ...
    return t.Wt = function(e) {
        ...
        get: function() {
            if (null === this.qt) {
                ...
                t.Y() || this.qt.push(new Ft(t)), this.qt.push(new Ft(P$1.J(), "asc" /* ASCENDING */)); else {
    ...
    t.prototype.canonicalId = function() {
        ...
        return !F$1(this.limit) && "F" /* First */ === this.Bt;
    }, t.prototype.ae = function() {
        return !F$1(this.limit) && "L" /* Last */ === this.Bt;
    ...
    t.prototype.ee = function() {
        ...
        var e = t.key.path;
        return null !== this.collectionGroup ? t.key.tt(this.collectionGroup) && this.path.q(e) : L$1.et(this.path) ? this.path.isEqual(e) : this.path.U(e);
    }, 
    /**
     ...
     */    return index_esm.__extends(n, e), n.create = function(t, e, r) {
        ...
        if (ot(r)) {
            if ("==" /* EQUAL */ !== e) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        ...
        // Only compare types with matching backend order (such as double and int).
                return null !== e && W$1(this.value) === W$1(e) && this.de(H$1(e, this.value));
        ...
        return t instanceof n && this.op === t.op && this.field.isEqual(t.field) && K$1(this.value, t.value);
    }, n.prototype.toString = function() {
    ...
    return index_esm.__extends(n, e), n.prototype.matches = function(t) {
    ...
    t.prototype.le = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.Y() ? L$1.N(L$1.Z(o.referenceValue), e.key) : H$1(o, e.field(i.field)), 
        ...
        for (var e = 0; e < this.position.length; e++) if (!K$1(this.position[e], t.position[e])) return !1;
        return !0;
    }, t;
}(), Ft = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.compare = function(t, e) {
        var n = this.fe ? L$1.N(t.key, e.key) : function(t, e, n) {
            var r = e.field(t), i = n.field(t);
            return null !== r && null !== i ? H$1(r, i) : xe();
        }(this.field, t, e);
        switch (this.dir) {
          case "asc" /* ASCENDING */ :
            return n;
     ...
     */ , s) {
        void 0 === i && (i = x$1.min()), void 0 === o && (o = x$1.min()), void 0 === s && (s = C$1.ht), 
 ...
 */ function zt(t) {
    ...
    return ke("GRPC error has no .code"), T$1.UNKNOWN;
    switch (t) {
      case At.OK:
        return T$1.OK;
 ...
 */ var ue = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.N = t ? function(e, n) {
            return t(e, n) || L$1.N(e.key, n.key);
        } : function(t, e) {
            return L$1.N(t.key, e.key);
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, fe.ds(e, n)), new t(x$1.min(), r, se(), $t(), ie());
    }, t;
}(), fe = /** @class */ function() {
    function t(
    /**
    ...
    return t.ds = function(e, n) {
        return new t(C$1.ht, n, ie(), ie(), ie());
    }, t;
}(), le = function(
    ...
    t.prototype.Hs = function(t) {
        ...
        if (r) {
            ...
            if (i.Ot()) if (0 === n) {
                ...
                // queries.
                var o = new L$1(i.path);
                this.Qs(e, o, new St(o, x$1.min()));
 ...
 */ var we = {
    ...
    return t.prototype.ni = function(t) {
        var e = void 0 === t.code ? T$1.UNKNOWN : zt(t.code);
    ...
    t.prototype.ai = function(t) {
        return B$1(t) ? this._t(t) : this.lt(t);
    }, 
    /**
    ...
    t.prototype.ci = function(t) {
        ...
        // in the local target cache.
                return 4 === e.length ? R$1.G : this.Ti(e);
    }, Object.defineProperty(t.prototype, "wi", {
        get: function() {
            return new R$1([ "projects", this.ii.projectId, "databases", this.ii.database ]).j();
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.li = function(t) {
        return new R$1([ "projects", t.projectId, "databases", t.database ]);
    }, t.prototype.Ti = function(t) {
    ...
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.Ri = function(t, e) {
        ...
        if ("targetChange" in t) {
            ...
            d.document;
            var y = this.Z(d.document), v = d.readTime ? this.fromVersion(d.readTime) : x$1.min(), m = new St(y, v), g = d.removedTargetIds || [];
            e = new le([], g, m.key, m);
        ...
        return e.targetIds && e.targetIds.length ? x$1.min() : e.readTime ? this.fromVersion(e.readTime) : x$1.min();
    }, t.prototype.vi = function(t) {
        var e, n = this;
...
}(), Ne = new index_esm.Logger("@firebase/firestore");
...
function De(t) {
    ...
    if (Ne.logLevel <= index_esm.LogLevel.DEBUG) {
        var i = e.map(Se);
        Ne.debug.apply(Ne, index_esm.__spreadArrays([ "Firestore (" + E$1 + "): " + t ], i));
    }
}

function ke(t) {
    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
    if (Ne.logLevel <= index_esm.LogLevel.ERROR) {
        var i = e.map(Se);
        Ne.error.apply(Ne, index_esm.__spreadArrays([ "Firestore (" + E$1 + "): " + t ], i));
    }
}
 ...
 */ function xe(t) {
    ...
    // exception is swallowed.
        var e = "FIRESTORE (" + E$1 + ") INTERNAL ASSERTION FAILED: " + t;
...
function(t, e, n, r, i) {
    ...
    t.prototype.Jn = function(t, e) {
        ...
        return this.Wn.Xn(t, e).next((function(r) {
            ...
            return i.forEach((function(t, e) {
                ...
                e || (e = new St(t, x$1.min())), o = o.Ae(t, e);
            })), o;
        }));
    }, 
    /**
    ...
    t.prototype.Zn = function(t, e, n) {
        ...
        return this.Kn(t, new L$1(e)).next((function(t) {
            var e = te();
...
var He = function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.Fr && (this.clearTimeout(), this.Dr.reject(new I$1(T$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    t.prototype.Jr = function(t) {
        return index_esm.__awaiter(this, void 0, void 0, (function() {
            var e;
            return index_esm.__generator(this, (function(n) {
                switch (n.label) {
                  case 0:
    ...
    t.prototype.Xr = function(t) {
        ...
        this.zr(), this.Or || (this.Lr = this.Lr.then((function() {
            var i = new He, o = function() {
                return index_esm.__awaiter(r, void 0, void 0, (function() {
                    var e;
                    return index_esm.__generator(this, (function(n) {
                        switch (n.label) {
                          case 0:
    ...
    t.prototype.eh = function() {
        return index_esm.__awaiter(this, void 0, void 0, (function() {
            var t;
            return index_esm.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
...
var rn = /** @class */ function() {
    ...
    t.prototype.Mh = function(t, e) {
        ...
        return this.Ch(t, this.yh.fh).next((function(e) {
            ...
            return h = Date.now(), Ae() <= index_esm.LogLevel.DEBUG && De("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - f) + "ms\n\tDetermined least recently used " + r + " in " + (u - o) + "ms\n\tRemoved " + i + " targets in " + (a - u) + "ms\n\tRemoved " + t + " documents in " + (h - a) + "ms\nTotal Duration: " + (h - f) + "ms"), 
            Be.resolve({
                ah: !0,
                uh: r,
                _h: i,
 ...
 */ var cn = /** @class */ function() {
    function t(e) {
        ...
        // log on 12.2.
        12.2 === t.Bh(index_esm.getUA()) && ke("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.")
        /**
    ...
    return t.qh = function(e, n, r) {
        return De("SimpleDb", "Opening database:", e), new Be((function(i, o) {
            ...
            s.onsuccess = function(e) {
                ...
                o(new I$1(T$1.FAILED_PRECONDITION, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
            }, s.onerror = function(t) {
                var e = t.target.error;
                "VersionError" === e.name ? o(new I$1(T$1.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : o(e);
    ...
    /** Returns true if IndexedDB is available in the current environment. */ t.Uh = function() {
        ...
        // Check the UA string to find out the browser.
                var e = index_esm.getUA(), n = t.Bh(e), r = 0 < n && n < 10, i = t.Wh(e), o = 0 < i && i < 4.5;
        // IE 10
    ...
    t.Wh = function(t) {
        ...
        return index_esm.__awaiter(this, void 0, void 0, (function() {
            var e, o, s, u, a;
            return index_esm.__generator(this, (function(h) {
                switch (h.label) {
                  case 0:
...
/** A mutation queue for a specific user, backed by IndexedDB. */ var gn = /** @class */ function() {
    ...
    return t.uo = function(e, n, r, i) {
        ...
        return this.lo(t).next((function(t) {
            return C$1.fromBase64String(t.lastStreamToken);
        }));
 ...
 */ var Nn = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Mo(t).next((function(t) {
            return x$1.v(new S$1(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
 ...
 */ var xn = /** @class */ function() {
    ...
    t.prototype.oa = function(t, e) {
        var n = this, r = Zt(), i = new Qt(L$1.N);
        return this.ha(t, e, (function(t, e) {
            var o = n.ia(e);
        ...
        return Rn(t).ro({
            ...
            for (var s = L$1.st(t); o && L$1.N(o, s) < 0; ) n(o, null), o = i.Ne();
            o && o.isEqual(s) && (
            // Key found in cache.
    ...
    t.prototype.ia = function(t) {
        if (t) {
            ...
            return e instanceof St && e.version.isEqual(x$1.min()) ? null : e;
        }
        return null;
    }, t;
}();
 ...
 */ xn.Ia = /** @class */ function(e) {
    ...
    return index_esm.__extends(n, e), n.prototype.xn = function(t) {
        ...
        return this.Dn.forEach((function(o, s) {
            ...
            if (s) {
                ...
                var c = e.Aa.serializer.Pa(new St(o, x$1.min()), e.readTime);
...
var Ln = /** @class */ function() {
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.O(), n = t.M(), r = this.index[e] || new Yt(R$1.N), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.O(), n = t.M(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Yt(R$1.N)).W();
    }, t;
     ...
     */
            return function(t) {
                ...
                /*highestTargetId=*/ 0, 
                /*lastListenSequenceNumber=*/ 0, x$1.min().C(), 
                /*targetCount=*/ 0);
...
var tr = index_esm.__spreadArrays(index_esm.__spreadArrays(index_esm.__spreadArrays([ jn.store, Bn.store, Gn.store, Wn.store, Yn.store, Fn.store, Xn.store, Hn.store ], [ Jn.store ]), [ Kn.store ]), [ $n.store ]), er = /** @class */ function() {
    function t() {
        /**
...
/** Serializer for values stored in the LocalStore. */ var rr = /** @class */ function() {
    ...
    /** Decodes a remote document from storage locally to a Document. */    return t.prototype._a = function(t) {
        ...
        if (t.noDocument) {
            var e = L$1.st(t.noDocument.path), n = this.ya(t.noDocument.readTime);
            return new St(e, n, {
                hasCommittedMutations: !!t.hasCommittedMutations
            });
        }
        if (t.unknownDocument) {
            var r = L$1.st(t.unknownDocument.path), i = this.ya(t.unknownDocument.version);
            return new xt(r, i);
        }
        return xe();
    }, 
    ...
    /** Decodes a DbMutationBatch into a MutationBatch */ t.prototype.Ro = function(t) {
        var e = this, n = (t.baseMutations || []).map((function(t) {
            ...
            return e.pa.Fi(t);
        })), i = S$1.fromMillis(t.localWriteTimeMs);
        return new Fe(t.batchId, i, n, r);
    }, 
    /** Decodes a DbTarget into TargetData */ t.prototype.Go = function(t) {
        var e, n = this.ya(t.readTime), r = void 0 !== t.lastLimboFreeSnapshotVersion ? this.ya(t.lastLimboFreeSnapshotVersion) : x$1.min();
        return e = void 0 !== t.query.documents ? this.pa.xi(t.query) : this.pa.Wi(t.query), 
        new jt(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, n, r, C$1.fromBase64String(t.resumeToken));
    }, 
    ...
    function t(e, n, r, i, o, s, u, a) {
        ...
        }, !t.Uh()) throw new I$1(T$1.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        ...
        this.Qn = new xn(this.serializer, this.jn), !i.window || !i.window.localStorage) throw new I$1(T$1.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
    ...
    t.prototype.za = function(t) {
        ...
        this.Tr.$r((function() {
            return index_esm.__awaiter(r, void 0, void 0, (function() {
                return index_esm.__generator(this, (function(t) {
                    switch (t.label) {
                      case 0:
        ...
        return ur(t).get(Fn.key).next((function(n) {
            ...
            if (null !== n && e.su(n.leaseTimestampMs, 5e3) && !e.ru(n.ownerId)) {
                ...
                if (!e.Za(n)) {
                    ...
                    throw new I$1(T$1.FAILED_PRECONDITION, ir);
                    return !1;
                }
            }
    ...
    t.prototype._u = function() {
        ...
        return this.Ba.runTransaction(o, tr, (function(o) {
            return i = new or(o, r.ja.next()), "readwrite-primary" === e ? r.Ha(o).next((function(t) {
                ...
                r.Tr.$r((function() {
                    return r.$a(!1);
                })), new I$1(T$1.FAILED_PRECONDITION, ze);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.Eu = function(t) {
        var e = this;
        return ur(t).get(Fn.key).next((function(t) {
            if (null !== t && e.su(t.leaseTimestampMs, 5e3) && !e.ru(t.ownerId) && !e.Za(t) && !t.allowTabSynchronization) throw new I$1(T$1.FAILED_PRECONDITION, ir);
        }));
    }, 
    /**
 ...
 */ var fr = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             * PORTING NOTE: This is only used for multi-tab synchronization.
             */
        this.pu = x$1.min(), this.Wn = t.lu(n), this.yu = t.fu(), this.Oa = t.du(), this.bu = new We(this.yu, this.Wn, this.persistence.Tu()), 
        this.Pu.vu(this.bu)
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.cs.forEach((function(i, h) {
                    ...
                    // cache.
                                        h instanceof St && h.version.isEqual(x$1.min()) ? (
    ...
    t.prototype.Wu = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.Yo(o, t.ee()).next((function(t) {
                ...
                return n.Pu.Zn(o, t, e ? r : x$1.min(), e ? i : ie());
            })).next((function(t) {
                return {
                    documents: t,
                    ju: i
...
var lr = /** @class */ function(r) {
    ...
    /** Starts the LocalStore. */    return index_esm.__extends(i, r), i.prototype.start = function() {
        return this.Ku();
    }, 
 ...
 */ var dr = /** @class */ function() {
    ...
    t.prototype.ic = function(t) {
        var e = this, n = L$1.EMPTY, r = new yr(n, t), i = new yr(n, t + 1), o = [];
        ...
        var e = L$1.EMPTY, n = new yr(e, t), r = new yr(e, t + 1), i = ie();
    ...
    return t.Ju = function(t, e) {
        return L$1.N(t.key, e.key) || Pe(t.hc, e.hc);
    }, 
    /** Compare by ID then by key */ t.Zu = function(t, e) {
        return Pe(t.hc, e.hc) || L$1.N(t.key, e.key);
    }, t;
}();
 ...
 */
function vr(t, e) {
    if (0 !== e.length) throw new I$1(T$1.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + Or(e.length, "argument") + ".");
}
 ...
 */ function mr(t, e, n) {
    if (e.length !== n) throw new I$1(T$1.INVALID_ARGUMENT, "Function " + t + "() requires " + Or(n, "argument") + ", but was called with " + Or(e.length, "argument") + ".");
}
 ...
 */ function gr(t, e, n) {
    if (e.length < n) throw new I$1(T$1.INVALID_ARGUMENT, "Function " + t + "() requires at least " + Or(n, "argument") + ", but was called with " + Or(e.length, "argument") + ".");
}
 ...
 */ function wr(t, e, n, r) {
    if (e.length < n || e.length > r) throw new I$1(T$1.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + Or(e.length, "argument") + ".");
}
...
function Nr(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var h = Dr(r);
        throw new I$1(T$1.INVALID_ARGUMENT, "Invalid value " + h + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
...
/** Helper to validate the type of a provided input. */ function Ar(t, e, n, r) {
    if (!("object" === e ? _r(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = Dr(r);
        throw new I$1(T$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
function kr(t, e, n) {
    if (void 0 === n) throw new I$1(T$1.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + Rr(e) + " argument, but it was undefined.");
}
 ...
 */ function Sr(t, e, n) {
    q$1(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new I$1(T$1.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function xr(t, e, n, r) {
    var i = Dr(r);
    return new I$1(T$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + Rr(n) + " argument to be a " + e + ", but it was: " + i);
}

function Vr(t, e, n) {
    if (n <= 0) throw new I$1(T$1.INVALID_ARGUMENT, 'Function "' + t + '()" requires its ' + Rr(e) + " argument to be a positive number, but it was: " + n + ".");
}
...
/** Helper function to assert Uint8Array is available at runtime. */ function Pr() {
    if ("undefined" == typeof Uint8Array) throw new I$1(T$1.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function Lr() {
    if (!Ie.nt().oc) throw new I$1(T$1.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var Ur = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ...
        try {
            ...
            throw new I$1(T$1.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        !function(t, e, n, r) {
            if (!(e instanceof Array) || e.length < 1) throw new I$1(T$1.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + Or(1, "element") + ".");
        }(0, t);
        for (var n = 0; n < t.length; ++n) if (Er("FieldPath", "string", n, t[n]), 0 === t[n].length) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.uc = new P$1(t);
    }
...
var Mr = new RegExp("[~\\*/\\[\\]]"), Cr = function(t) {
    ...
    return index_esm.__extends(n, e), n.prototype.Di = function(t) {
    ...
    function t(t, e) {
        ...
        !isFinite(t) || t < -90 || t > 90) throw new I$1(T$1.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new I$1(T$1.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.Ic = t, this.wc = e;
    }
...
/** A "context" object passed around while parsing user data. */ var Xr = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.mc = function(e) {
        ...
        return new I$1(T$1.INVALID_ARGUMENT, "Function " + this.settings.methodName + "() called with invalid data. " + t + e);
    }, 
    ...
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.Sc = function(t, e, n) {
        ...
        if (n) {
            for (var u = [], a = 0, h = n; a < h.length; a++) {
                ...
                if (!r.contains(f)) throw new I$1(T$1.INVALID_ARGUMENT, "Field '" + f + "' is specified in your field mask but missing from your input data.");
                ii(u, f) || u.push(f);
            }
    ...
    /** Parse update data from a list of field/value arguments. */ t.prototype.Cc = function(t, e, n, r) {
        ...
        if (r.length % 2 != 0) throw new I$1(T$1.INVALID_ARGUMENT, "Function " + t + "() needs to be called with an even number of arguments that alternate between field names and values.");
...
function ti(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof S$1 || t instanceof Qr || t instanceof Ur || t instanceof $i || t instanceof Cr);
}
 ...
 */ function ni(t, e) {
    ...
    throw new I$1(T$1.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. Field path arguments must be of type string or FieldPath.");
}
 ...
 */ function ri(t, e) {
    try {
        return function(t) {
            ...
            try {
                return new (qr.bind.apply(qr, index_esm.__spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
        ...
        throw new I$1(T$1.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. " + n);
    }
    /**
 ...
 */ var oi = /** @class */ function() {
    ...
    t.prototype.zc = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new I$1(T$1.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.Xc(e);
            }));
        }));
        ...
        this.state = 4 /* Backoff */ , this.Qr.gr((function() {
            return index_esm.__awaiter(t, void 0, void 0, (function() {
                return index_esm.__generator(this, (function(t) {
    ...
    return index_esm.__extends(n, e), n.prototype.Zc = function(t) {
    ...
    return index_esm.__extends(n, e), Object.defineProperty(n.prototype, "h_", {
        /**
    ...
    /** Gets an auth token and invokes the provided RPC. */    return index_esm.__extends(n, e), n.prototype.l_ = function(t, e) {
        var n = this;
        return this.credentials.getToken().then((function(r) {
            return n.Mc.l_(t, e, r);
        })).catch((function(t) {
            throw t.code === T$1.UNAUTHENTICATED && n.credentials._(), t;
        }));
    }, 
    ...
    return t.prototype.R_ = function(t) {
        return index_esm.__awaiter(this, void 0, void 0, (function() {
            var r, i = this;
            return index_esm.__generator(this, (function(o) {
                switch (o.label) {
                  case 0:
        ...
        return index_esm.__awaiter(this, void 0, void 0, (function() {
            var t, r = this;
            return index_esm.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
        ...
        if (null !== n) {
            ...
            throw new I$1(T$1.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.P_ = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new I$1(T$1.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    r, i, o, s) {
        ...
        this.L_ = !1, this.O_ = s, this.O_.x_((function(t) {
            i.$r((function() {
                return index_esm.__awaiter(u, void 0, void 0, (function() {
                    return index_esm.__generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
    ...
    t.prototype.ll = function(t) {
        ...
        return index_esm.__awaiter(this, void 0, void 0, (function() {
            return index_esm.__generator(this, (function(e) {
                ...
                this.G_.lastStreamToken = C$1.ht, this.F_.fo(C$1.ht).catch(pr)) ] : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.Il = function(t) {
        return index_esm.__awaiter(this, void 0, void 0, (function() {
...
var yi = /** @class */ function() {
    ...
    return t.Vl = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = se(), s = 0; i && s < r.activeTargetIds.length; ++s) i = B$1(r.activeTargetIds[s]), 
    ...
    function t(e, n, r, i, o) {
        ...
        /**
             ...
             */
        this.Cl = [], !t.Uh(this.platform)) throw new I$1(T$1.UNIMPLEMENTED, "LocalStorage is not available on this platform.");
    ...
    return t.prototype.$d = function() {
        ...
        try {
            ...
            return !F$1(e) && e.catch && e.then ? e : (this.Dr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
            ...
            return index_esm.__generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 3:
                    ...
                    void r.reject(new I$1(T$1.UNAVAILABLE, "Failed to persist write: " + i))) ];
                    throw i;
            ...
            return index_esm.__generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.Gd = this.Gd.remove(i), this.zd.delete(t), this.af(), o = (o = new Qt(L$1.N)).Ae(i, new St(i, x$1.min())), 
                    s = ie().add(i), u = new ce(x$1.min(), 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.lf = function(t) {
        this.Jd.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new I$1(T$1.CANCELLED, t));
            }));
        })), this.Jd.clear();
    ...
    return index_esm.__extends(i, r), Object.defineProperty(i.prototype, "Zd", {
        get: function() {
    ...
    i.prototype.wf = function(t) {
        ...
        this.zd.forEach((function(e, n) {
            t.Nd.nl(n);
        })), this.Hd.nc(), this.zd = new Map, this.Gd = new Qt(L$1.N);
    }, 
    /**
    ...
    i.prototype.mf = function(t) {
        ...
        return index_esm.__awaiter(this, void 0, void 0, (function() {
            ...
            return index_esm.__generator(this, (function(d) {
                switch (d.label) {
                  case 0:
            ...
            return index_esm.__generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 3:
                    ...
                    return [ 2 /*return*/ , void t.onError(new I$1(T$1.UNAVAILABLE, u)) ];
    ...
    return t.prototype.vu = function(t) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var u = i.xf(e, o);
            return (e.oe() || e.ae()) && i.pd(e.Bt, u, r, n) ? i.Of(t, e) : (Ae() <= index_esm.LogLevel.DEBUG && De("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
    ...
    t.prototype.pd = function(t, e, n, r) {
        ...
        return Ae() <= index_esm.LogLevel.DEBUG && De("IndexFreeQueryEngine", "Using full collection scan to execute query: %s", e.toString()), 
    ...
    return t.prototype.co = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                L$1.et(i) || (i = i.child(""));
        var o = new yr(new L$1(i), 0), s = new Yt(Pe);
    ...
    t.prototype.$n = function(t) {
        ...
        for (var r = te(), i = new L$1(e.path.child("")), o = this.docs.ve(i)
...
var Ui = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        ...
        throw new I$1(T$1.FAILED_PRECONDITION, "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.");
    }, t;
}(), ji = /** @class */ function(r) {
    function i() {
        return null !== r && r.apply(this, arguments) || this;
    }
    return index_esm.__extends(i, r), i.prototype.initialize = function(t) {
        return index_esm.__awaiter(this, void 0, void 0, (function() {
            var i = this;
            return index_esm.__generator(this, (function(o) {
                switch (o.label) {
                  ...
                  case 1:
                    ...
                    return o.sent(), [ 4 /*yield*/ , this.persistence.Ka((function(t) {
                        return index_esm.__awaiter(i, void 0, void 0, (function() {
                            return index_esm.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
        ...
        if (t.AT.mT && t.AT.synchronizeTabs) {
            if (!Ei.Uh(t.platform)) throw new I$1(T$1.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            var e = sr.Iu(t.RT);
    ...
    t.prototype.VT = function(t, r, i, o) {
        return index_esm.__awaiter(this, void 0, void 0, (function() {
            var s, u, a, h, c = this;
            return index_esm.__generator(this, (function(f) {
                switch (f.label) {
                  case 0:
                  ...
                  case 2:
                    ...
                    this.persistence.Ga((function() {
                        return index_esm.__awaiter(c, void 0, void 0, (function() {
                            return index_esm.__generator(this, (function(t) {
                                switch (t.label) {
                                  case 0:
    ...
    t.prototype.PT = function() {
        if (this.br.Kr) throw new I$1(T$1.FAILED_PRECONDITION, "The client has already been terminated.");
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return this.PT(), this.br.enqueue((function() {
            ...
            throw new I$1(T$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)");
        }));
...
var Qi = /** @class */ function() {
    ...
    return t.prototype.NT = function(t) {
        ...
        return new Qr(J$1(t.latitude), J$1(t.longitude));
        ...
        var e = Z$1(t), n = new S$1(e.seconds, e.nanos);
        return this.timestampsInSnapshots ? n : n.toDate();
    }, t.prototype.MT = function(t) {
        var e = R$1.K(t);
        Ve(Te(e));
        var n = new Me(e.get(1), e.get(3)), r = new L$1(e.$(5));
    ...
    function t(t) {
        var e, n;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new I$1(T$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
        ...
        Ir("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = nn.mh; else {
            if (t.cacheSizeBytes !== Wi && t.cacheSizeBytes < nn.Ah) throw new I$1(T$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + nn.Ah);
    ...
    function t(r, i, o) {
        ...
        this.qT = new Ze, this.INTERNAL = {
            delete: function() {
                return index_esm.__awaiter(s, void 0, void 0, (function() {
                    return index_esm.__generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
            ...
            var a = r;
            if (!a.projectId) throw new I$1(T$1.INVALID_ARGUMENT, "Must provide projectId");
            this.Nc = new Me(a.projectId, a.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.jT = "[DEFAULT]", this.KT = new A$1;
        }
    ...
    return t.prototype.settings = function(t) {
        ...
        var e = new Ki(t);
        if (this.QT && !this.zT.isEqual(e)) throw new I$1(T$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        this.zT = e, void 0 !== e.credentials && (this.KT = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new I$1(T$1.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
    }, t.prototype.enableNetwork = function() {
        ...
        var e, n;
        if (this.QT) throw new I$1(T$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1;
        ...
        if (e = t.options, !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new I$1(T$1.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 */        if (!n || "string" != typeof n) throw new I$1(T$1.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new Me(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.BT) throw new I$1(T$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.BT;
        },
        enumerable: !0,
        configurable: !0
        ...
        this.UT(), new ro(R$1.K(t), this);
    }, t.prototype.doc = function(t) {
        return mr("Firestore.doc", arguments, 1), Er("Firestore.doc", "non-empty string", 1, t), 
        this.UT(), $i.eE(R$1.K(t), this);
    }, t.prototype.collectionGroup = function(t) {
        if (mr("Firestore.collectionGroup", arguments, 1), Er("Firestore.collectionGroup", "non-empty string", 1, t), 
        t.indexOf("/") >= 0) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
        return this.UT(), new eo(new Rt(R$1.G, t), this);
        ...
        t) {
          case "debug":
            _e(index_esm.LogLevel.DEBUG);
            break;

          case "error":
            _e(index_esm.LogLevel.ERROR);
            break;

          case "silent":
            _e(index_esm.LogLevel.SILENT);
            break;

          default:
            throw new I$1(T$1.INVALID_ARGUMENT, "Invalid log level: " + t);
        }
    }, 
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        if (this.oE) throw new I$1(T$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), $i = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.eE = function(e, n, r) {
        if (e.length % 2 != 0) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + e.j() + " has " + e.length);
        return new t(new L$1(e), n, r);
        ...
        !t) throw new I$1(T$1.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = R$1.K(t);
        ...
        var r = this.uE({
            ...
            next: function(i) {
                ...
                e(new I$1(T$1.UNAVAILABLE, "Failed to get document because the client is offline.")) : i.exists && i.metadata.fromCache && n && "server" === n.source ? e(new I$1(T$1.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : t(i);
            },
            error: e
        });
    ...
    return index_esm.__extends(n, e), n.prototype.data = function(t) {
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        var i, o = function(t, e, n, r) {
            if (!e.some((function(t) {
                return t === r;
            }))) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid value " + Dr(r) + " provided to function Query.where() for its " + Rr(2) + " argument. Acceptable values: " + e.join(", "));
            return r;
        ...
        if (s.Y()) {
            if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            if ("in" /* IN */ === o) {
                this.TE(r, o);
        ...
        void 0 === n || "asc" === n) r = "asc" /* ASCENDING */; else {
            if ("desc" !== n) throw new I$1(T$1.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
        if (null !== this.fE.startAt) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.fE.endAt) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.RE = function(t, e, n, r) {
        if (kr(t, 1, e), e instanceof Ji) {
            if (n.length > 0) throw new I$1(T$1.INVALID_ARGUMENT, "Too many arguments provided to " + t + "().");
            var i = e;
            if (!i.exists) throw new I$1(T$1.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + t + "().");
    ...
    t.prototype.AE = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.fE.orderBy; r < i.length; r++) {
            ...
            if (o.field.Y()) n.push(et(this.firestore.Nc, t.key)); else {
                ...
                if (G$1(s)) throw new I$1(T$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + o.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === s) {
                    var u = o.field.j();
                    throw new I$1(T$1.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + u + "' (used as the orderBy) does not exist.");
                }
                n.push(s);
            }
        }
    ...
    t.prototype.mE = function(t, e, n) {
        ...
        var r = this.fE.xt;
        if (e.length > r.length) throw new I$1(T$1.INVALID_ARGUMENT, "Too many arguments provided to " + t + "(). The number of arguments must be less than or equal to the number of Query.orderBy() clauses");
        for (var i = [], o = 0; o < e.length; o++) {
            var s = e[o];
            if (r[o].field.Y()) {
                if ("string" != typeof s) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + t + "(), but got a " + typeof s);
                if (!this.fE._e() && -1 !== s.indexOf("/")) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.fE.path.child(R$1.K(s));
                if (!L$1.et(u)) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new L$1(u);
        ...
        if (t.ae() && 0 === t.xt.length) throw new I$1(T$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }, t.prototype.get = function(t) {
        var e = this;
        ...
        var r = this.uE({
            ...
            next: function(i) {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                r(), i.metadata.fromCache && n && "server" === n.source ? e(new I$1(T$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : t(i);
            },
            error: e
        });
    }, 
    ...
    t.prototype.EE = function(t) {
        if ("string" == typeof t) {
            if ("" === t) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!this.fE._e() && -1 !== t.indexOf("/")) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.fE.path.child(R$1.K(t));
            if (!L$1.et(e)) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
            return et(this.firestore.Nc, new L$1(e));
        }
        if (t instanceof $i) {
            var n = t;
            return et(this.firestore.Nc, n.kc);
        }
        throw new I$1(T$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Dr(t) + ".");
    }, 
    /**
    ...
    t.prototype.TE = function(t, e) {
        if (!Array.isArray(t) || 0 === t.length) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
        if (t.length > 10) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
        if (t.indexOf(null) >= 0) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'null' in the value array.");
        if (t.filter((function(t) {
            return Number.isNaN(t);
        })).length > 0) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
    }, t.prototype.IE = function(t) {
        if (t instanceof Ot) {
            ...
            if (t.ue()) {
                var o = this.fE.jt();
                if (null !== o && !o.isEqual(t.field)) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + o.toString() + "' and '" + t.field.toString() + "'");
                var s = this.fE.Kt();
                ...
                throw u === t.op ? new I$1(T$1.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + t.op.toString() + "' filter.") : new I$1(T$1.INVALID_ARGUMENT, "Invalid query. You cannot use '" + t.op.toString() + "' filters with '" + u.toString() + "' filters.");
            }
        }
        ...
        if (!e.isEqual(t)) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + t.toString() + "' and so you must also use '" + t.toString() + "' as your first Query.orderBy(), but your first Query.orderBy() is on field '" + e.toString() + "' instead.");
    }, t;
}(), no = /** @class */ function() {
    function t(t, e, n, r) {
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        if (e && this.pE.hs) throw new I$1(T$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    return index_esm.__extends(n, e), Object.defineProperty(n.prototype, "id", {
        get: function() {
        ...
        get: function() {
            ...
            return t.B() ? null : new $i(new L$1(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
        ...
        "" === t) throw new I$1(T$1.INVALID_ARGUMENT, "Document path must be a non-empty string");
        var e = R$1.K(t);
...
function io(t, e) {
    ...
    if (Sr(t, e, [ "merge", "mergeFields" ]), Ir(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new I$1(T$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + Dr(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new I$1(T$1.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + Dr(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof qr;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new I$1(T$1.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
...
function uo(t, e, n) {
    if (e instanceof $i) {
        if (e.firestore !== n) throw new I$1(T$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
...
function co(t, e) {
    function n() {
        ...
        throw e && (t += " ", t += e), new I$1(T$1.INVALID_ARGUMENT, t);
    }
...
var fo = co(Yi, "Use firebase.firestore() instead."), lo = co(Hi, "Use firebase.firestore().runTransaction() instead."), po = co(Xi, "Use firebase.firestore().batch() instead."), yo = co($i, "Use firebase.firestore().doc() instead."), vo = co(Ji), mo = co(to), go = co(eo), wo = co(no), Eo = co(ro, "Use firebase.firestore().collection() instead."), bo = co(/** @class */ function() {
    ...
    Commit: "commit"
}, ko = "gl-js/ fire/" + E$1, So = /** @class */ function() {
    function t(t) {
        this.ii = t.ii;
     ...
     */    return t.prototype.jE = function(t, e) {
            ...
            u.listenOnce(esm_3.COMPLETE, (function() {
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case esm_2.TIMEOUT:
                        De("Connection", 'RPC "' + t + '" timed out'), s(new I$1(T$1.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                var i = function(t) {
                                    ...
                                    return Object.values(T$1).indexOf(e) >= 0 ? e : T$1.UNKNOWN;
                                }(r.status);
                                s(new I$1(i, r.message));
                            } else s(new I$1(T$1.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        De("Connection", 'RPC "' + t + '" failed'), s(new I$1(T$1.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.WE, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = esm_1(), i = {
        ...
        index_esm.isMobileCordova() || index_esm.isReactNative() || index_esm.isElectron() || index_esm.isIE() || index_esm.isUWP() || index_esm.isBrowserExtension() || (i.httpHeadersOverwriteParam = "$httpHeaders");
        var o = n.join("");
        ...
        return v(esm_4.EventType.OPEN, (function() {
            ...
            d || (d = !0, De("Connection", "WebChannel transport errored:", t), y.UE(new I$1(T$1.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                if (i) {
                    ...
                    void 0 === u && (u = T$1.INTERNAL, a = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    d = !0, y.UE(new I$1(u, a)), s.close();
 ...
 */
    !function(t, e) {
        t.INTERNAL.registerComponent(new index_esm.Component("firestore", (function(t) {
            return function(t, e) {
...
}())), xo(index_esm.firebase$1);

exports.__PRIVATE_registerFirestore = xo;
//# sourceMappingURL=index.esm-0adc47d9.js.map
