...
export class FkDoesNotExist<S extends ISdk, T extends Model> extends FireModelError {
  constructor(pk: Record<T, S>, property: string, fkId: string) {
    // TODO: is this typing right for constructor?
    const fkModelName =
      pk.META.relationship("property").fkConstructor().constructor.name;
