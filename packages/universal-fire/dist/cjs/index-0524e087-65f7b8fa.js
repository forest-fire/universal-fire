...
async function importFakerLibrary() {
    if (!faker) {
        faker = await Promise.resolve().then(function () { return require(/* webpackChunkName: "faker-lib" */ './index-62be410f-d727bee0-fcff9043.js'); }).then(function (n) { return n.i; });
    }
    return faker;
}
/**
...
//# sourceMappingURL=index-0524e087-65f7b8fa.js.map
